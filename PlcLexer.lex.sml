...
\\034\032\003\003\003\003\030\003\029\028\027\026\025\023\003\022\
\\020\020\020\020\020\020\020\020\020\020\018\017\015\013\003\003\
\\003\007\007\007\007\007\007\007\007\007\007\007\007\007\007\007\
\\007\007\007\007\007\007\007\007\007\007\007\011\003\010\003\007\
\\003\007\007\007\007\007\007\007\007\007\007\007\007\007\007\007\
...
{fin = [], trans = 1},
{fin = [(N 71)], trans = 0},
{fin = [(N 48),(N 71)], trans = 0},
{fin = [(N 69),(N 71)], trans = 0},
{fin = [(N 46),(N 71)], trans = 0},
{fin = [(N 14),(N 71)], trans = 7},
{fin = [(N 14)], trans = 8},
{fin = [(N 14)], trans = 7},
{fin = [(N 41),(N 71)], trans = 0},
{fin = [(N 39),(N 71)], trans = 11},
{fin = [(N 44)], trans = 0},
{fin = [(N 34),(N 71)], trans = 13},
{fin = [(N 67)], trans = 0},
{fin = [(N 29),(N 71)], trans = 15},
{fin = [(N 32)], trans = 0},
{fin = [(N 61),(N 71)], trans = 0},
{fin = [(N 54),(N 71)], trans = 18},
{fin = [(N 57)], trans = 0},
{fin = [(N 9),(N 71)], trans = 20},
{fin = [(N 9)], trans = 20},
{fin = [(N 22),(N 71)], trans = 0},
{fin = [(N 18),(N 71)], trans = 23},
{fin = [(N 64)], trans = 0},
{fin = [(N 59),(N 71)], trans = 0},
{fin = [(N 16),(N 71)], trans = 0},
{fin = [(N 20),(N 71)], trans = 0},
{fin = [(N 52),(N 71)], trans = 0},
{fin = [(N 50),(N 71)], trans = 0},
{fin = [(N 71)], trans = 30},
{fin = [(N 27)], trans = 0},
{fin = [(N 24),(N 71)], trans = 32},
{fin = [(N 37)], trans = 0},
{fin = [(N 4),(N 71)], trans = 34},
{fin = [(N 4)], trans = 34},
{fin = [(N 1)], trans = 0}])
end
...
| 14 => let val yytext=yymktext() in keyword(yytext), yypos, yypos end
| 16 => (PLUS, yypos, yypos)
...
| 27 => (AND, yypos, yypos)
| 29 => (LESS, yypos, yypos)
| 32 => (LESSEQ, yypos, yypos)
| 34 => (EQ, yypos, yypos)
| 37 => (NOTEQ, yypos, yypos)
| 39 => (LBRACK, yypos, yypos)
| 4 => (lex())
| 41 => (RBRACK, yypos, yypos)
| 44 => (DBRACK, yypos, yypos)
| 46 => (LBRACE, yypos, yypos)
| 48 => (RBRACE, yypos, yypos)
| 50 => (LPAR, yypos, yypos)
| 52 => (RPAR, yypos, yypos)
| 54 => (COLON, yypos, yypos)
| 57 => (DCOLON, yypos, yypos)
| 59 => (COMMA, yypos, yypos)
| 61 => (SEMIC, yypos, yypos)
| 64 => (ARROW, yypos, yypos)
| 67 => (DARROW, yypos, yypos)
| 69 => (VBAR, yypos, yypos)
| 71 => let val yytext=yymktext() in error("\n***Lexer error: bad character***\n"); raise Fail("Lexer error: bad character "^ yytext) end
| 9 => let val yytext=yymktext() in INTC(strToInt(yytext), yypos, yypos) end
