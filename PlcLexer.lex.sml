...
\\033\031\003\003\003\003\029\003\028\027\026\025\003\023\003\022\
...
{fin = [(N 14),(N 67)], trans = 7},
{fin = [(N 14)], trans = 8},
{fin = [(N 14)], trans = 7},
{fin = [(N 41),(N 67)], trans = 0},
{fin = [(N 39),(N 67)], trans = 11},
{fin = [(N 44)], trans = 0},
{fin = [(N 34),(N 67)], trans = 13},
{fin = [(N 63)], trans = 0},
{fin = [(N 29),(N 67)], trans = 15},
{fin = [(N 32)], trans = 0},
{fin = [(N 57),(N 67)], trans = 0},
{fin = [(N 67)], trans = 18},
{fin = [(N 55)], trans = 0},
{fin = [(N 9),(N 67)], trans = 20},
{fin = [(N 9)], trans = 20},
{fin = [(N 22),(N 67)], trans = 0},
{fin = [(N 18),(N 67)], trans = 23},
{fin = [(N 60)], trans = 0},
{fin = [(N 16),(N 67)], trans = 0},
{fin = [(N 20),(N 67)], trans = 0},
{fin = [(N 52),(N 67)], trans = 0},
{fin = [(N 50),(N 67)], trans = 0},
{fin = [(N 67)], trans = 29},
{fin = [(N 27)], trans = 0},
{fin = [(N 24),(N 67)], trans = 31},
{fin = [(N 37)], trans = 0},
{fin = [(N 4),(N 67)], trans = 33},
{fin = [(N 4)], trans = 33},
{fin = [(N 1)], trans = 0}])
end
